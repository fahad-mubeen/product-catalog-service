...
import com.project.ProductCatalogService.exception.GlobalExceptionHandler;
...
public class CategoryControllerTest {
    ...
    void getAllCategories_shouldReturnAllCategories() throws Exception {
        ...
        categoryDTOList.add(CategoryDTO.builder().id(2L).name("Computers").build());
        categoryDTOList.add(CategoryDTO.builder().id(3L).name("Books").build());
        ...
        mockMvc.perform(get("/categories"))
                ...
                .andExpect(jsonPath("$[1].name").value("Computers"))
